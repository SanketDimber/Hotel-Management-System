				...
				<td colspan=2> <font color=#5C3317> <center><b>Thanks for interested in hotel royel.</b></center><br><br></font></td>
      			...
      			<tr>
					...
					<?php
						...
						$res=mysqli_query($con,"select * from usr");
						...
						mysqli_query($con,"insert into registration values('".$fname."','".$lname."','".$bdt."',".$phno.",'".$gender."','".$email."','".$uname."','".$pwd."','".$cpwd."')");

						mysqli_query($con,"insert into usr values('".$uname."','".$pwd."');");
