...
create table IF NOT EXISTS room(type varchar(20) not null primary key,total_room int not null,reserv_room int not null,avail_room int not null,charge_day int not  null);
